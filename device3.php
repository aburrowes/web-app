...
<html>
  ...
  <head>
    ...
    <h1>Scan Item QR Code to Device 3! </h1>
  </head>
  <head>
    <meta charset="utf-8">
      ...
      document.querySelector('#start-button').addEventListener('click', function () {
        if (selectedCameraId) {
          ...
          scanner.addListener('scan', function(content) {
            ...
            if (url !== '') {
              window.location.href = 'http://192.168.1.102/demo/qr-data.php?&api_key=tpmat5ab3j7f9&device=3&item=' + encodeURIComponent(url); //192.168.1.102
            } 
            else {
